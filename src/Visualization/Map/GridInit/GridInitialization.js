...
export const moveObject = (grid, row, col, object, startNode, goalNode, setStartNode, setGoalNode) => {
    const tempRow = object === "start1" || object === "start2" ? startNode.row : goalNode.row;
    const tempCol = object === "start1" || object === "start2" ? startNode.col : goalNode.col;
